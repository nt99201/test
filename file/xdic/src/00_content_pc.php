...
<style type="text/css">
            ...
            .file_list li:nth-child(9),.file_list li:nth-child(10),.file_list li:nth-child(11),
            .file_list li:nth-child(12),.file_list li:nth-child(13),.file_list li:nth-child(14),
            .file_list li:nth-child(15),.file_list li:nth-child(16),.file_list li:nth-child(17){background:#3366CC}

			.file_list li:nth-child(18),.file_list li:nth-child(19),.file_list li:nth-child(20),
			.file_list li:nth-child(21),.file_list li:nth-child(22),.file_list li:nth-child(23),
			.file_list li:nth-child(24),.file_list li:nth-child(25),.file_list li:nth-child(26),
			.file_list li:nth-child(27),.file_list li:nth-child(28),.file_list li:nth-child(29){background:#660099}

            .file_list li:nth-child(30),.file_list li:nth-child(31),.file_list li:nth-child(32),
           	.file_list li:nth-child(33),.file_list li:nth-child(34),.file_list li:nth-child(35),
           	.file_list li:nth-child(36),.file_list li:nth-child(37),.file_list li:nth-child(38),
           	.file_list li:nth-child(39),.file_list li:nth-child(40),.file_list li:nth-child(41){background:#663366}

           	.file_list li:nth-child(42),.file_list li:nth-child(43){background:#666633}

			.file_list li:nth-child(44),.file_list li:nth-child(45),.file_list li:nth-child(46),
			.file_list li:nth-child(47),.file_list li:nth-child(48),.file_list li:nth-child(49){background:#CC6600}

			.file_list li:nth-child(50),.file_list li:nth-child(51),.file_list li:nth-child(52),
			.file_list li:nth-child(53),.file_list li:nth-child(54),.file_list li:nth-child(55),
			.file_list li:nth-child(56),.file_list li:nth-child(57),.file_list li:nth-child(58),
			.file_list li:nth-child(59),.file_list li:nth-child(60),.file_list li:nth-child(61){background:#CC9933}

</style>

<ul class="file_list">
<li class="noti">
	PC 레이아웃입니다.<br> 모바일버전은 우측하단 버튼을 클릭하세요.
</li>
<?php
		$fileNames = array(
		    '03_main.php' => '메인',
		    ...
		    '03_main_mn_ly.php' => '레이어 : 몽골어 콘텐츠교체공지팝업',
		    '03_main_intro_pc.php' => '사전이용 tip : 편리한 입력 - PC',
		    '03_main_intro2_pc.php' => '사전이용 tip : 편리한 입력2 - PC',
		    '03_main_intro3_pc.php' => '사전이용 tip : 활용정보 - PC',
		    '03_main_intro4_pc.php' => '사전이용 tip : 활용정보2 - PC',
		    '03_main_intro5_pc.php' => '사전이용 tip : 내가찾은 단어 - PC',
		    '03_main_intro6_pc.php' => '사전이용 tip : 내가찾은 단어2 - PC',
		    ...
		    '08_cmt.php' => '의견 및 내용오류신고',
		    '08_cmt_write.php' => '의견 및 내용오류신고 : 의견 쓰기',
		    '08_cmt_all.php' => '의견 및 내용오류신고 : 의견 모음',
		    '08_cmt_view_none.php' => '의견 및 내용오류신고 : 의견 탭 - 댓글 없음',
		    '08_pc_cmt.php' => '의견 및 내용오류신고 : 의견 탭 - 보기 - PC',
		    '08_pc_cmt2.php' => '의견 및 내용오류신고 : 내용오류신고 탭 - 보기 - PC',
        ...
        foreach ($fileNames as $key => $val) {
            if($key == "03_main_banner.php" || $key == "03_main_language_ly.php" || $key == "03_main_kh_ly.php" || $key == "03_main_mn_ly.php") {
?>
                <li><a href="?page=03_main.php&layer=<?= $key ?>"><?= $val ?></a></li>
<?php
			} else if($key == "05_helpdic_ly.php") {
?>
                <li><a href="?page=05_helpdic.php&layer=<?= $key ?>"><?= $val ?></a></li>
<?php
			} else if(strpos($key,"pop_") !== false) {
?>
