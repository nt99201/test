...
<div id="ct">
	...
	<div class="ads_sc">
		<p>
			<a href="#appLink" id="applink"><img src="http://imgcomic.naver.com/mobilewebimg/81482/461/49b473a03e08b37401f27398189649fe_014.jpg" class="fx2" fixedheight="600" alt="AD"></a>
...
<div class="ly_wrap ly_store">
	<div class="ly_cont">
		<h2 class="ly_tit">2011 미스테리 단편</h2>
		<div class="info">
			<p class="ly_txt">30~79화는 스토어에서 구매 후<br>이용할 수 있습니다.</p>
			<p class="ly_txt">감상을 위해 스토어로 이동하시겠습니까?</p>
		</div>
		<div class="btn_set"><button type="button" class="btn_bx">아니요</button><button type="button" class="btn_bx2">예</button></div>
		<a href="#none" class="ly_clse"><span>레이어 창 닫기</span></a>
	</div>
</div>
