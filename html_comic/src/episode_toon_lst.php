<?php $searchType='search'; $pageTitle='회차 리스트&#62; 요일웹툰2'; $menu='week'; include 'inc/header.php'; ?>
...
<div class="lnb_sub bx_tab">
	...
	<li class="on"><a href="#none">일</a></li>
...
<div id="ct">
	<div class="chh toon_info">
		...
		<div class="info_in">
			<dl>
			<dt><span class="title"><strong>개발테스트용 스마트툰가나다라마바사아자차카타파하</strong></span><span class="aside_info"><span class="ico_smart">스마트툰</span><span class="ico_break">휴재</span></span></dt>
			<dd class="info_name">
