<?php $pageTitle='회차 리스트&#62; 베스트 도전 - 포텐업'; $menu='challenge';$searchType='search'; include 'inc/header.php'; ?>
...
<div id="ct">
	<div class="chh toon_info">
		<span class="im_br">
			<span class="im_inbr">
				<img src="http://thumb.comic.naver.net/nas/user_contents_data/challenge_comic/2015/11/16/all_gold/thumbnail_title_all_gold_111112_.jpg" width="63" height="51" alt="프로필이미지">
		...
		<div class="info_in">
			<dl>
			<dt><span><strong>다이아 하트의 안내인</strong></span></dt>
			<dd class="info_name">
				<span class="nm"><span>all_gold</span></span><span><a href="#">첫회보기</a></span>
			</dd>
			</dl>
		</div>

		<!-- 좋아요 기능 -->
		<?php $pageType='episode_lst';$likeYN='N'; include 'inc/likeit.php' ?>
		<!-- //좋아요 기능 -->
	</div>
