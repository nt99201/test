...
<div id="ct">
			...
			<a href="#">
				...
				<div class="toon_info">
					<h4>
						...
						<span class="aside_info"><span class="ico_adult2">19세 이상 이용가</span><span class="ico_cut">컷툰</span></span>
					</h4>
	...
	<li>
		...
		<div class="lst">
			<a href="#">
				<span class="im_br"><span class="im_inbr"><img src="im/@tmp/@top_toon.png" width="71" height="42" alt="소년들은 무엇을 하고 있을까"></span></span>
				<div class="toon_info">
					<h4>
						<span class="toon_name"><strong><span>소년들은 무엇을 하고 있을까</span></strong></span>
					</h4>
					<p class="sub_info">컷부<span class="bar">|</span><strong>61. 소년들의 미션은 무엇일까</strong></p>
				</div>
			</a>
		</div>
	</li>
...
<div class="ly_wrap">
	<div class="ly_cont v1">
		<div class="info">
			<strong><span>최신 본 웹툰에서 삭제</span>하시겠습니까?</strong>
		</div>
