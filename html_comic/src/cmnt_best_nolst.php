<?php $pageTitle='BEST 댓글(없는 경우)';$searchType='search'; include 'inc/header.php'; ?>
<!-- ct  -->
<hr />
<div id="ct">
	<form name="form" id="form" method="post">
		...
		<div class="u_comment_box u_comment_v2" id="comment_module">
			<div class="u_section">
				...
				<div class="nv"><a href="#" class="on"><em>BEST</em> 댓글</a><a href="#">전체 댓글</a></div>
				<h2 class="u_hc">BEST 댓글</h2>
			</div>

			<div class="msg_nolist">
				이번 화의 <em>BEST</em> 댓글이 아직 없습니다.<br>
				전체댓글에서 '<span>좋아요</span>'를 눌러<br>
				<em>BEST</em> 댓글을 만들어 주세요.
			</div>
