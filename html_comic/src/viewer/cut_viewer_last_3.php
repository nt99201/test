                            ...
                            <div class="flick-ct">
                                <div class="cut_viewer_last">
                                    ...
                                    <div class="star" id="starDiv">
                                        ...
                                        <div class="pnt"><span class="u_grp"><span id="starScore" class="u_grp_v" style="width:48.00000190734863%;"></span></span> <span id="avgStarscore"><em class="score">4.8</em></span> <span class="tjoin" id="starscoreCount"><em>7,753</em>명 참여</span>
                                            <!-- [D] 참여완료한 경우 클래스 없음  -->
                                            <a href="#" style="display:none"><span id="starToggleButton" class="up">별점닫기</span></a>
                                            <span>참여완료</span>
                                        </div>
                                    ...
                                    <div class="wr">
                                        ...
                                        <p class="dsc">다리는 맛있다 다리는 맛있어<br>인간적으로 이 웹툰엔 별점테러하지 맙시다.<br>
                                        다리는 맛있다 다리는 맛있어<br>인간적으로 이 웹툰엔 별점테러하지 맙시다.<br>
                                        다리는 맛있다 다리는 맛있어<br>인간적으로 이 웹툰엔 별점테러하지 맙시다.<br>
                                        가나다마바사아자차카타파하<br>abcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrstuvwxyz
                                        </p>
                                    </div>
                                    <!-- //작가의 말 -->
                                    ...
                                    <!-- //소셜플러그인 -->
                                    <!-- 파생 상품(스팩 및 디자인 미 확정) -->
                                    <!-- [D] 관련 상품 없는 경우 hide 클래스 추가 -->
                                    <div class="product_lst_wrap hide">
