<?php $page='comment comment2'; include '../inc/header_viewer.php'; ?>
    ...
    <div class="commentDiv">
        <div class="u_comment_box u_comment_v2" id="comment_module" style="overflow: hidden;">
            <div class="u_section">
                ...
                <div class="nv"><a href="javascript:;" id="bestTab" onclick="toggleCommentTab('best')" class="on"><em>BEST</em> 댓글</a><a href="javascript:;" id="newTab" onclick="toggleCommentTab('newest')" class="">전체 댓글</a></div>
