...
<link type="text/css" rel="stylesheet" href="http://dev.ui.naver.com/m.common/like/branches/s_150121_likeIt/css/likeItList_COMIC.css" charset="utf-8">
<link rel="stylesheet" type="text/css" href="../css/comment_comic_w.css">

<style type="text/css">
@media screen and (orientation:landscape){
    .cut_viewer_wrap .flick-ct .cut_img img{width:auto !important}
}
@media screen and (min-width:768px){
    .cut_viewer_wrap .flick-ct .cut_img img{height:100% !important}
}
</style>
<!-- 마크업확인용 진도 스크립트 -->
