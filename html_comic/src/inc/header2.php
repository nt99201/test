...
<link rel="stylesheet" type="text/css" href="css/mediaScreen_real.css" />
<link charset="utf-8" rel="stylesheet" type="text/css" href="http://m.like.naver.com/css/likeIt.css">
<link charset="utf-8" rel="stylesheet" type="text/css" href="http://dev.ui.naver.com/svnview/m.common/like/branches/p_130521_like/src/css/likeit_comic.css">
...
<header>
	...
	<!-- 전체서비스 -->
	<div id="u_gnbw" class="u_gnbw">
		<span class="u_hc">전체서비스</span>
		<a href="#u_gnbuw" class="u_gnbt"><span>전체서비스 펼치기</span></a>
		<div id="u_gnbf"></div>
	</div>
	<!-- //전체서비스 -->
...
?>
			<div class="lnb">
				...
				<?php
					...
					if($search_txt){
						// 작품별 보기 상세인 경우
						echo '<h2>W.I.T.C.H - 마법소녀 위치 W.I.T.C.H - 마법소녀 위치 W.I.T.C.H - 마법소녀 위치 W.I.T.C.H - 마법소녀 위치 W.I.T.C.H - 마법소녀 위치</h2>';
					}else{
				...
				<?php switch ($menu) {
					case 'main':
						echo'<li class="on"><a href="#">홈</a></li>
							...
							<li><a href="#">스토어<span>신규</span></a></li>
							<li><a href="#">MY</a></li>';
						break;
					case 'week':
						echo'<li><a href="#">홈</a></li>
							<li class="on"><a href="#">요일웹툰</a></li>
							<li><a href="#">베스트도전</a></li>
							<li><a href="#">스토어<span>신규</span></a></li>
							<li><a href="#">MY</a></li>';
						break;
