...
* c3p project is licensed under the MIT license
* https://pages.oss.navercorp.com/chart/c3p/LICENSE.txt
*
* C3+; C3.js enhancement library
* https://pages.oss.navercorp.com/chart/c3p/
*
* @version 1.0.0
* @SHA-1 2079e65 (1.0.0-rc)
*/
/**
* All-in-one packaged file for ease use of 'C3+' with below dependencies.
